;; 1.25
;; she's correct. we could have written it this way.
;; However, it would not have served us well for testing larger numbers since that would quickly take a^n out of bounds and vastly increase computation
